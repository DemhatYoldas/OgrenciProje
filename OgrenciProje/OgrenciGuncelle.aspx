<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="OgrenciGuncelle.aspx.cs" Inherits="OgrenciProje.OgrenciGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:Button ID="BtnGuncelles" runat="server" Text="Güncelle" CssClass="btn btn-primary" OnClick="BtnGncle" />
        </div>
    </form>
</asp:Content>
